								...
								<div class="form-body">
									<div class="form-group form-md-line-input">
										<select class="form-control" id="" name="txCurso">
											...
											<option value="<?=$cursos[$i]['id']?>"><?=$cursos[$i]['curso']?></option>
											<?}?>
										</select>
									...
									<div class="form-group form-md-line-input ">
										<input type="date" class="form-control date" id="" name="txEncerramento">
									...
									<div class="form-group form-md-line-input">
										...
										<div class="md-checkbox-inline">
											<div class="md-checkbox">
												<input type="checkbox" id="txDomingo" class="md-check" name="txDomingo" value=1>
												<label for="txDomingo">
												<span></span>
												<span class="check"><i class="fa fa-check"></i></span>
												<span class="box"></span>
									...
									<div class="form-group form-md-line-input">
										...
										<div class="md-checkbox-inline">
											<div class="md-checkbox">
												<input type="checkbox" id="txSegunda" class="md-check" name="txSegunda" value=1>
												<label for="txSegunda">
												<span></span>
												<span class="check"><i class="fa fa-check"></i></span>
												<span class="box"></span>
									...
									<div class="form-group form-md-line-input">
										...
										<div class="md-checkbox-inline">
											<div class="md-checkbox">
												<input type="checkbox" id="txTerca" class="md-check" name="txTerca" value=1>
												<label for="txTerca">
												<span></span>
												<span class="check"><i class="fa fa-check"></i></span>
												<span class="box"></span>
									...
									<div class="form-group form-md-line-input">
										...
										<div class="md-checkbox-inline">
											<div class="md-checkbox">
												<input type="checkbox" id="txQuarta" class="md-check" name="txQuarta" value=1>
												<label for="txQuarta">
												<span></span>
												<span class="check"><i class="fa fa-check"></i></span>
												<span class="box"></span>
									...
									<div class="form-group form-md-line-input">
										...
										<div class="md-checkbox-inline">
											<div class="md-checkbox">
												<input type="checkbox" id="txQuinta" class="md-check" name="txQuinta" value=1>
												<label for="txQuinta">
												<span></span>
												<span class="check"><i class="fa fa-check"></i></span>
												<span class="box"></span>
									...
									<div class="form-group form-md-line-input">
										...
										<div class="md-checkbox-inline">
											<div class="md-checkbox">
												<input type="checkbox" id="txSexta" class="md-check" name="txSexta" value=1>
												<label for="txSexta">
												<span></span>
												<span class="check"><i class="fa fa-check"></i></span>
												<span class="box"></span>
									...
									<div class="form-group form-md-line-input">
										...
										<div class="md-checkbox-inline">
											<div class="md-checkbox">
												<input type="checkbox" id="txSabado" class="md-check" name="txSabado" value=1>
												<label for="txSabado">
												<span></span>
												<span class="check"><i class="fa fa-check"></i></span>
												<span class="box"></span>
