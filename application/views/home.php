...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<h3 class="page-title">
			Painel <small>estatísticas & atividades</small>
			</h3>
			<!-- END PAGE HEADER-->
			...
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat blue-madison">
						...
						<a class="more" href="<?=base_url();'cursos';?>">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat red-intense">
						...
						<a class="more" href="<?=base_url();'turmas';?>">
						Ver mais <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat green-haze">
						...
						<a class="more" href="<?=base_url();'alunos';?>">
						Ver mais <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="dashboard-stat purple-plum">
						...
						<a class="more" href="<?=base_url();'visitas';?>">
						Ver mais <i class="m-icon-swapright m-icon-white"></i>
						</a>
					</div>
				</div>
					...
					<div class="portlet light ">
						<div class="portlet-title">
							<div class="caption">
								...
								<span class="caption-subject font-green-sharp bold uppercase">Agenda de Visitas</span>
								<span class="caption-helper">prospecção</span>
							</div>
							<div class="actions">
								<div class="btn-group btn-group-devided" data-toggle="buttons">
									<label class="btn btn-transparent grey-salsa btn-circle btn-sm active">
									<input type="radio" name="options" class="toggle" id="option1">Pendentes</label>
									<label class="btn btn-transparent grey-salsa btn-circle btn-sm">
									<input type="radio" name="options" class="toggle" id="option2">Realizadas</label>
								</div>
							</div>
						</div>
